...
//!
//! ```
//! use burn_neat::poly::core::neuron::PolyNeuronInner;
//! use burn_neat::poly::core::neuron_type::{PolyProps, PropsType};
//! use burn_neat::poly::core::input::PolyInput;
//!
...
/// ```
/// use burn_neat::poly::core::neuron::PolyNeuronInner;
/// use burn_neat::poly::core::neuron_type::PolyProps;
/// use burn_neat::poly::core::input::PolyInput;
///
...
impl<N, I> PolyNeuronInner<N, I> {
    ...
    /// ```
    /// use burn_neat::poly::core::neuron::PolyNeuronInner;
    /// use burn_neat::poly::core::neuron_type::{PolyProps, NeuronType};
    ///
    /// let input = PolyNeuronInner::new(1, None);
...
///
/// ```
/// use burn_neat::poly::core::neuron::{PolyNeuronInner, Neuron};
///
/// struct MyNeuron {
