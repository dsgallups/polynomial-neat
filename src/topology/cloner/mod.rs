...
pub struct NetworkReplicator {
    neurons: Vec<Arc<RwLock<NeuronReplicator>>>,
...
impl NetworkReplicator {
    ...
    pub fn neurons(&self) -> &[Arc<RwLock<NeuronReplicator>>] {
        &self.neurons
    }
    ...
    pub fn random_neuron(&self, rng: &mut impl Rng) -> &Arc<RwLock<NeuronReplicator>> {
        self.neurons
    ...
    pub fn push(&mut self, rep: Arc<RwLock<NeuronReplicator>>) {
        self.neurons.push(rep);
    }

    pub fn deep_clone(&self) -> NetworkReplicator {
    ...
    //#[instrument(skip_all)]
    pub fn replicate(&self, rng: &mut impl Rng) -> NetworkReplicator {
...
fn make_simple_network() {
    ...
    let topology = NetworkReplicator::from_raw_parts(
